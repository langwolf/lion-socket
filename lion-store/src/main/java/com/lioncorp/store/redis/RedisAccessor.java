...
public class RedisAccessor extends RedisAccessorBase {
    ...
    public List<String> hmget(final String key, final String[] fields) {
        return new ReadCommandTemplate<List<String>>(key,  Collections.emptyList()) {
            @Override
            public List<String> read(JedisCluster client, String redisKey) {
                List<String> list = client.hmget(redisKey, fields);
